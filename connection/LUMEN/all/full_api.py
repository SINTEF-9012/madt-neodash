...
# from kafka import KafkaConsumer, OffsetAndMetadata, TopicPartition, KafkaProducer
...
### ______________________________________________CONFIGURATION___________________________________________________
...
### ______________________________________________OTHER GLOBAL VAR___________________________________________________
...
#### ______________________________________START MINIO________________________________________####
...
def minio_upload_file():
    ...
    try:
        ...
        if os.path.exists(file_path):
            os.remove(file_path)
    print("HERE3")
    print({'status': 200, 'file_name':file_name, 'add_date':now.strftime("%Y-%m-%d %H:%M:%S"), 'format':file_name.split(".")[-1]})
...
#### ______________________________________END MINIO________________________________________####

#### ______________________________________START INFLUXDB________________________________________####
...
'''
#### ______________________________________END INFLUXDB________________________________________####


#### ______________________________________START NEO4J________________________________________####
...
#### ______________________________________END NEO4J________________________________________####

#### ______________________________________START LUMEN________________________________________####
...
###____________________________________________END LUMEN_____________________________________________________
